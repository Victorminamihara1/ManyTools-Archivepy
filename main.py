...
from organizer import FileOrganizer   # <<<<<< ADICIONA ISSO
...
def main():
    ...
    tab_pipeline = [
        ...
        [sg.Button("Processar TUDO", key="-RUN-", bind_return_key=True),
         sg.Button("Abrir relatório", key="-OPENREL-")]
    ]
    ...
    try:
        ...
        pass  # se não tiver ainda

    # função para rodar organizer em thread
